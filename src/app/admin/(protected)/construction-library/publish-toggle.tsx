...
import { publishLibraryItemAction } from "@/features/construction-library/construction-library.actions";
    ...
    <Button
      ...
      onClick={() =>
        startTransition(async () => {
          const result = await publishLibraryItemAction(id, !isPublished);
